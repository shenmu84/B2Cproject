                ...
                if (this.editing_address_index === '') {
                    ...
                    axios.post(url, this.form_address, {
                        ...
                        .then(response => {
                            ...
                            location.href = 'static/user_center_site.html'
                        })
                        .catch(error => {
                            console.log(error);
                        })
            ...
            axios.delete(this.host + '/addresses/' + this.addresses[index].id + '/', {
                ...
                .then(response => {
                    ...
                    if (response.data.code == 0) {
                        location.href = 'http://www.meiduo.site:8000/static/user_center_site.html'
                    }
            ...
            axios.get(this.host + '/addresses/', {
                ...
                .catch(error => {
                    ...
                    if (status == 401 || status == 403) {
                        location.href = 'static/login.html?next=/user_center_site.html';
                    } else {
